...
2. Verifique se o valor da alienação fiduciária está em reais.
  2a. Se o valor da alienação fiduciária ou débito fiduciário aparece no edital, use esse valor pois é mais atualizado.
  2b. Se o valor da alienação fiduciária ou débito fiduciário não aparece no edital, use o valor que aparece na matrícula.
